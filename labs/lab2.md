...
```bash
- Registro de fichaje para el día 02-08-2023 -
...
Escriba un programa para registrar la cantidad de horas trabajadas en el archivo `registro-dia-mes-año.txt`.
...
```bash
Fecha inicial (formato dd.mm.yyyy): 01.08.2023
Cantidad de días: 5

Ingrese la cantidad de horas trabajadas.

Tiempo para el día 01.08.2023: 6
Tiempo para el día 02.08.2023: 8
Tiempo para el día 03.08.2023: 8
Tiempo para el día 04.08.2023: 10
Tiempo para el día 05.08.2023: 4

Se ha almacenado la información en el archivo registro-21-12-2021.txt
```

El archivo `registro-01-08-2023.txt` debe contener la siguiente información:

```
Período: 01.08.2023 al 05.08.2023
Total de horas: 36
Promedio horas: 7,2 horas por día
-- Detalle:
01.08.2023: 6
02.08.2023: 8
03.08.2023: 8
